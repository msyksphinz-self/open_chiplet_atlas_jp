...
.. figure:: images/fig08_address_domain.png
   :alt: 図8. アドレスドメインの例とそれらの間のアドレス変換。

   図8. アドレスドメインの例とそれらの間のアドレス変換。
...
.. tip::
   ...
   [OPT-ADDR-3] 送信元アドレス領域のD2Dポートに割り当てられたアドレス領域のベースアドレスは、ブートチャネル(セクション4.3)を介して、ターゲット領域のアドレス変換ロジックを設定するエージェントに提供されるべきである。
...
図9は、ローカルルーティングドメイン間のチップレット間ルーティングと、異なるNoC設計におけるルーティングコンテキストの処理を示しています。
...
.. figure:: images/fig09_routing_domain.png
   :alt: 図9. ローカル配線ドメイン間におけるチップ間配線。

   図9. ローカル配線ドメイン間におけるチップ間配線。
...
図10は共有ルーティングドメイン内の2つのCPUチップレット間におけるチップレット間ルーティングの例を示す。
...
.. figure:: images/fig10_shared_routing_domain.png
   :alt: 図10. 共有ルーティングドメインにおけるチップ間ルーティング

   図10. 共有ルーティングドメインにおけるチップ間ルーティング
